  ...
  return (
    <div className="bg-black">
      <div className="container mx-auto px-4 py-8">
        ...
        <form action={addUser} className="w-full max-w-lg">
        ...
        <footer className="mt-8">
          <div className="flex justify-between">
            <div>
              <h2 className="text-xl font-bold text-whitemb-2">Our Address</h2>
              <p className="123 Main St, Sacramento, CA 12345">
                123 Main St, Sacramento, CA 12345
              </p>
            </div>
            <div>
              ...
              <p className="text-white">Email: info@sacramentokingsmerch.com</p>
            </div>
            <div>
              <h2 className="text-xl font-bold text-white mb-2">
                Connect With Us
              ...
              <div className="flex space-x-4">
                <a
                  href="https://www.instagram.com/sacramentokings/"
                ...
                <a
                  href="https://www.facebook.com/sacramentokings/"
                  className="text-purple-800 hover:text-purple-700"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  href="https://twitter.com/SacramentoKings/"
                  className="text-purple-800 hover:text-purple-700"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
